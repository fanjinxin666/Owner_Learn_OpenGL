#include "Introduce_Hello_Triangle.h"
#include <iostream>
#include <thread>

Introduce_Hello_Triangle::Introduce_Hello_Triangle()
{
	glfwInit();
...
void Introduce_Hello_Triangle::processInput(GLFWwindow *window)
{
...
// ---------------------------------------------------------------------------------------------
void Introduce_Hello_Triangle::framebuffer_size_callback(GLFWwindow* window, int width, int height)
{
...
void Introduce_Hello_Triangle::processEventLoop()
{
